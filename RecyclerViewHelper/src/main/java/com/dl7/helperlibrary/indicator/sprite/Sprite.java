package com.dl7.helperlibrary.indicator.sprite;
...
import com.dl7.helperlibrary.indicator.animation.AnimationUtils;
import com.dl7.helperlibrary.indicator.animation.FloatProperty;
import com.dl7.helperlibrary.indicator.animation.IntProperty;
...
//        invalidateSelf();
    ...
    /**
     * drawable可以通过该方法来安排动画的下一帧。可以仅仅简单的调用postAtTime(Runnable, Object, long)来实现该方法。
     * 参数分别与方法的参数对应
