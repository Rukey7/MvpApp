 ...
 * 图片列表
 */
public class PhotoListFragment extends BaseFragment implements IPhotoListView {
    ...
    protected void initViews() {
        ...
        RecyclerViewHelper.initRecyclerViewV(mContext, mRvPhotoList, new AlphaInAnimationAdapter(animAdapter));
